...
import com.flux740.app.BuildConfig
...
import com.flux740.app.constant.Status
...
import com.flux740.app.data.entities.BookProgress
...
import com.flux740.app.help.TTS
...
import com.flux740.app.help.book.isEpub
import com.flux740.app.help.book.isLocal
import com.flux740.app.help.book.isLocalTxt
import com.flux740.app.help.book.isMobi
import com.flux740.app.help.book.removeType
import com.flux740.app.help.book.update
import com.flux740.app.help.config.AppConfig
import com.flux740.app.help.config.ReadBookConfig
import com.flux740.app.help.config.ReadTipConfig
...
import com.flux740.app.model.analyzeRule.AnalyzeRule
import com.flux740.app.model.analyzeRule.AnalyzeRule.Companion.setChapter
import com.flux740.app.model.analyzeRule.AnalyzeRule.Companion.setCoroutineContext
import com.flux740.app.utils.GSON
import com.flux740.app.utils.fromJsonObject
import com.flux740.app.utils.isJsonObject
import com.flux740.app.model.localBook.EpubFile
import com.flux740.app.model.localBook.MobiFile
import com.flux740.app.receiver.NetworkChangedListener
import com.flux740.app.receiver.TimeBatteryReceiver
import com.flux740.app.service.BaseReadAloudService
import com.flux740.app.ui.about.AppLogDialog
import com.flux740.app.ui.book.bookmark.BookmarkDialog
import com.flux740.app.ui.book.changesource.ChangeBookSourceDialog
import com.flux740.app.ui.book.changesource.ChangeChapterSourceDialog
import com.flux740.app.ui.book.info.BookInfoActivity
import com.flux740.app.ui.book.read.config.AutoReadDialog
import com.flux740.app.ui.book.read.config.BgTextConfigDialog.Companion.BG_COLOR
import com.flux740.app.ui.book.read.config.BgTextConfigDialog.Companion.TEXT_ACCENT_COLOR
import com.flux740.app.ui.book.read.config.BgTextConfigDialog.Companion.TEXT_COLOR
import com.flux740.app.ui.book.read.config.MoreConfigDialog
import com.flux740.app.ui.book.read.config.ReadAloudDialog
import com.flux740.app.ui.book.read.config.ReadStyleDialog
import com.flux740.app.ui.book.read.config.TipConfigDialog.Companion.TIP_COLOR
import com.flux740.app.ui.book.read.config.TipConfigDialog.Companion.TIP_DIVIDER_COLOR
import com.flux740.app.ui.book.read.page.ContentTextView
import com.flux740.app.ui.book.read.page.ReadView
import com.flux740.app.ui.book.read.page.delegate.ScrollPageDelegate
import com.flux740.app.ui.book.read.page.entities.PageDirection
import com.flux740.app.ui.book.read.page.entities.TextPage
import com.flux740.app.ui.book.read.page.provider.ChapterProvider
import com.flux740.app.ui.book.read.page.provider.LayoutProgressListener
import com.flux740.app.ui.book.searchContent.SearchContentActivity
import com.flux740.app.ui.book.searchContent.SearchResult
import com.flux740.app.model.SourceCallBack
import com.flux740.app.ui.book.source.edit.BookSourceEditActivity
import com.flux740.app.ui.book.toc.TocActivityResult
import com.flux740.app.ui.book.toc.rule.TxtTocRuleDialog
import com.flux740.app.ui.browser.WebViewActivity
import com.flux740.app.ui.dict.DictDialog
...
import com.flux740.app.ui.replace.edit.ReplaceEditActivity
import com.flux740.app.ui.widget.PopupAction
import com.flux740.app.ui.widget.dialog.PhotoDialog
import com.flux740.app.utils.ACache
import com.flux740.app.utils.Debounce
import com.flux740.app.utils.LogUtils
import com.flux740.app.utils.NetworkUtils
import com.flux740.app.utils.StartActivityContract
import com.flux740.app.utils.applyOpenTint
import com.flux740.app.utils.buildMainHandler
import com.flux740.app.utils.dismissDialogFragment
import com.flux740.app.utils.getPrefBoolean
import com.flux740.app.utils.getPrefString
import com.flux740.app.utils.hexString
import com.flux740.app.utils.iconItemOnLongClick
...
import com.flux740.app.utils.navigationBarGravity
...
import com.flux740.app.utils.sysScreenOffTime
import com.flux740.app.utils.throttle
...
import com.flux740.app.model.analyzeRule.AnalyzeUrl.Companion.paramPattern
