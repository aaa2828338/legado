...
import com.flux740.app.help.storage.BackupConfig
...
import com.flux740.app.utils.toEditable
...
class BackupConfigFragment : PreferenceFragment(),
    ...
    override fun onCreatePreferences(savedInstanceState: Bundle?, rootKey: String?) {
        ...
        findPreference<com.flux740.app.lib.prefs.Preference>("web_dav_restore")
            ?.onLongClick {
                restoreFromLocal()
                true
            }
